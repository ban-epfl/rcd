...
def test_with_data():
    """L-MARVEL should achieve a high F1 score with Fisher-Z CI tests."""
...
def test_with_perfect_ci():
    """Perfect CI oracles should make L-MARVEL exact across many random graphs."""
    n = 20
    p = 2 * np.log(n) / n
    ...
    for i in range(num_graphs_to_test):
        ...
        learned_skeleton = l_marvel.learn_and_get_skeleton(
            ci_test,
            data_df,
